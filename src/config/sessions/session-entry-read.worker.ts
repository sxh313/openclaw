...
/** Full selected rows and their header fallback share one admitted database snapshot. */
      ...
      withSqlitePostCommitPublications(database.db, () =>
        runSqliteDeferredTransactionSync(database.db, () => {
          ...
          const selected = expectDefined(
            readExactSessionEntryCandidatesInDatabase(database, [request.sessionKeys], "full")[0],
